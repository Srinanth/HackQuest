    ...
    <div className="min-h-screen bg-[#f7f6f2] flex flex-col font-sans text-[#0e0e0e]">
      ...
      <nav className="sticky top-0 z-50 h-[56px] bg-[#f7f6f2]/90 backdrop-blur-md border-b border-[#e4e2de] flex items-center justify-between px-[1.75rem]">
        ...
        <div className="flex items-center gap-[10px]">
          <button className="bg-[#0e0e0e] text-[#fff] border-none px-[15px] py-[7px] rounded-[20px] text-[12.5px] font-sans font-medium cursor-pointer hover:opacity-75 transition-opacity">
            New Session
          </button>
          <div className="w-[28px] h-[28px] rounded-full bg-[#1a6b5c] text-white flex items-center justify-center text-[10px] font-semibold cursor-pointer">
            JV
          </div>
        </div>
      </nav>
